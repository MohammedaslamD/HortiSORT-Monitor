...
async function main() {
  ...
  await prisma.machine.createMany({
    data: [
      ...
      { id: 8, machine_code: 'HS-2025-0008', machine_name: 'HortiSort Pro', model: 'HS-Pro', serial_number: 'SN-PRO-0008', customer_id: 2, engineer_id: 4, location: 'Azadpur Mandi, GT Karnal Road', city: 'Delhi', state: 'Delhi', country: 'India', grading_features: 'size,color,weight', num_lanes: 6, software_version: 'v2.4', installation_date: new Date('2025-03-10'), status: 'down', last_updated: new Date('2026-03-11T15:00:00Z'), last_updated_by: 4, is_active: true, created_at: new Date('2025-03-10T10:00:00Z'), updated_at: new Date('2026-03-11T15:00:00Z') },
  ...
  await prisma.ticketComment.createMany({
    data: [
      ...
      { id: 6, ticket_id: 2, user_id: 2, message: 'This is the second time the belt has had issues. Please check the root cause.', created_at: new Date('2026-03-12T08:00:00Z') },
